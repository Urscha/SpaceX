'''
This is the simulated annealing algorithm to solve problem C of the Space Freight case
...
def cost(ships):
	...
	percentage_kg_filled = kgs_taken / CARGO_KG
...
def main():
	ships, cargolist = [], []
	read_data("CargoList2.txt", cargolist)
	init_ships(ships)
